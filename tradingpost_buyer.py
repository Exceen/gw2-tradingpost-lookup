...
def select_item():
    result_list = gw2api.get_current_transactions_buys()
    ...
    while True:
        ...
        while True:
            ...
            try:
                ...
                for listing in gw2api.get_current_transactions_buys():
...
def get_listings(_id):
    return gw2api.get_listings(_id)['buys'][:15]
